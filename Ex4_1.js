const gods = [
  ...
  const godCountFeatures = gods.map(god => god.features)
  
  console.log(`There are ${godCount} gods. Names: ${godNames.join(', ')}`);
  console.log(`There are ${godCount} gods. Names: ${godNames.join(', ')}`);

for (let i = 0; i < godCountFeatures.length; i++) {
  console.log(`God ${i+1} features: ${godCountFeatures[i].join(', ')}`);
}